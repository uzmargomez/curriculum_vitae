...
\bigskip
As an ML Programmer at Rockstar Games, I deploy and administer the Kubernetes infrastructure for the ML Animation Team, using tools such as Kubectl, Helm, Ansible, ArgoCD, Grafana, and Hashicorp Vault. I have hands-on experience applying Machine Learning algorithms to complex and realistic problems, using Python and C++ as my main programming languages.
