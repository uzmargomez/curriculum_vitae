...
\textbf{Mar 2023 - Present}. ML R\&D Programmer at Rockstar Games, specializing in the deployment and management of on-premises Kubernetes infrastructure for the ML Animation Team. Proficient in using tools such as Kubectl, Helm, Ansible, ArgoCD, Grafana, and HashiCorp Vault. Actively involved in all stages of machine learning model development, from data gathering and preprocessing to model training, evaluation, and production deployment. These models are used for asset creation in our projects.
