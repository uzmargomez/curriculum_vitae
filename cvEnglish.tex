...
GenAI & Langgraph, Langfuse, vLLM, FastMCP \\
	...
	Kubernetes Infrastructure & Kubectl, Helm, Kustomize, Ansible, ArgoCD, Grafana, Prometheus, HashiCorp Vault, MetalLB, NGINX Ingress, Istio Gateway, GSLB, Cilium\\
	%	\multicolumn{2}{c}{} \\
\end{tabular}
\bigskip
...
\textbf{Mar 2023 - Present}. ML R\&D Programmer at Rockstar Games, specializing in the deployment and management of on-premises Kubernetes infrastructure for the ML Animation Team. Proficient in using tools such as Kubectl, Helm, Ansible, ArgoCD, Grafana, and HashiCorp Vault, as well as managing diverse databases including MongoDB, Redis, PostgreSQL and Elasticsearch. Actively involved in all stages of machine learning model development, from data gathering and preprocessing to model training, evaluation, and production deployment. Implemented Large Language Models (LLMs) systems with Langgraph, deployed LLMs with vLLM, integrated Retrieval-Augmented Generation (RAG) systems for context-aware responses, used FastMCP to connect LLMs to tools and data.
