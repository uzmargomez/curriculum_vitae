...
%\par{\centering{\huge \textsc{Uzmar de Jesus Gomez Yanez}}\bigskip\par} % Your name
...
\par{\centering{\large \textsc{
			{\color{brown}ML and DevOps Engineer}}\bigskip\par}


\bigskip
\section{Personal Statement}
\bigskip
As an ML and DevOps Engineer at Rockstar Games, I deploy and administer the Kubernetes infrastructure for the ML Animation Team, using tools such as Kubectl, Helm, Ansible, ArgoCD, Grafana, and Hashicorp Vault. I have hands-on experience applying Machine Learning algorithms to complex and realistic problems, using Python and C++ as my main programming languages. I have end-to-end experience with all stages of the Machine Learning model lifecycle, including design, creation, training, deployment, monitoring, and productionalization. I have experience deploying and optimizing Large Language Models (LLMs), including fine-tune for specific use cases and implementing Retrieval-Augmented Generation (RAG) for context-aware responses, creating MCP servers and Langgraph agents, and others.

I hold a Master's degree in Scientific Computing and Data Analysis from Durham University, where I also served as a Student Representative for the MiSCaDA program. I have a strong background in mathematics, physics, and computer science. I am passionate about learning new technologies and techniques, and I enjoy collaborating with other talented and creative professionals.
...
\textsc{ResearchGate:} & \href{https://www.researchgate.net/profile/Uzmar-Gomez}{https://www.researchgate.net/profile/Uzmar-Gomez}
...
\textbf{Mar 2023 - Present}. ML R\&D Programmer at Rockstar Games, specializing in the deployment and management of on-premises Kubernetes infrastructure for the ML Animation Team. Proficient in using tools such as Kubectl, Helm, Ansible, ArgoCD, Grafana, and HashiCorp Vault, as well as managing diverse databases including MongoDB, Redis, PostgreSQL and Elasticsearch. Actively involved in all stages of machine learning model development, from data gathering and preprocessing to model training, evaluation, and production deployment. Implemented Large Language Models (LLMs) systems with Langgraph, deployed LLMs with vLLM, integrated Retrieval-Augmented Generation (RAG) systems for context-aware responses, used FastMCP to connect LLMs to tools and data, amongst other tasks.

\textbf{Sep 2022 - Mar 2023}. Associate ML R\&D Programmer at Rockstar Games.

\textbf{Jul 2020 - Jan 2022}. Data Scientist at Rackspace Technology. I helped migrate data from on-premises servers to the GCP cloud. I worked on churn prediction models that used features related to the COVID19 spreading aside from other business-related features to predict customer attrition, this work includes the development of the model using XGBoost, as well as the deployment of it using Kubeflow and the serving via Seldon Core. I was also involved in constructing an SSAS OLAP Cube to be used by the company for inventory-related queries. I worked on NLP tasks, such as extracting themes out of tickets using semantic similarity, by getting embeddings vectors out of sentences with a transformer architecture named Universal Sentence Encoder. Worked on how to translate voice to text. I built two production-level applications using Plotly Dash.

\textbf{Dec 2019 - Jun 2020}. Data Scientist at Softtek. I worked on a face recognition system using a method called Sparse Representation and another one using Neural Networks. I acquired a deep understanding of Neural Networks for Face Detection and Recognition, Image Classification, and Language Processing, among others, as well as some experience in Data Visualization tools such as Tableau.

\textbf{Sep 2019 - Dec 2019}. Data Scientist Trainee at Softtek. I learned about different statistical and machine learning techniques and algorithms to study a wide variety of problems.
...
\textbf{2016 - 2019}. Worked as a Teacher's Assistant. I've given lectures aimed at Computer Science and Physics Students on the following topics:
\begin{itemize}
...
\begin{tabular}{r|p{10.5cm}}
	...
	Machine/Deep Learning & TensorFlow, Keras, PyTorch, ARIMA, SARIMA, LDA, PCA, Kmeans, KNN, Neural Networks, Recommendation systems, Classification and Regression problems\\
	Serving & Triton, Seldon Core, TFServing \\
	VectorDB & Milvus \\
    GenAI & Langgraph, Langfuse, vLLM, LiteLLM, FastMCP \\
	Databases & PostgreSQL, Clickhouse, MongoDB, Elasticsearch, Redis \\
	Containers & Docker, Kubernetes \\
	Operating Systems & GNU/Linux, Windows \\
	Web Backend & FastAPI, Flask \\
	Web Frontend & Streamlit, HTML (Plotly Dash), Bootstrap \\
	Version Control & Git, Perforce \\
	Parallel Computing & C++ Standard Algorithms, CUDA Python\\
	Data Visualization & Plotly Dash, Qlik, Tableau \\
 	Automation & Airflow \\
  	Machine Learning & ClearML, Kubeflow \\
	GCP Tools & BigQuery, BQ ML, Compute Engine, Composer (Airflow), Artifact Registry, Kubernetes Engine, Storage, Data Studio, Kubeflow, Data Fusion, Cloud Build, VertexAI \\
	Kubernetes Infrastructure & Kubectl, Helm, Kustomize, Ansible, ArgoCD, Grafana, Prometheus, HashiCorp Vault, MetalLB, NGINX Ingress, Istio Gateway, Cilium\\
	%	\multicolumn{2}{c}{} \\
\end{tabular}
\bigskip
...
\begin{tabular}{r|p{14.5cm}}	
	...
	%------------------------------------------------	
	\textsc{2022} & \textbf{MSc in Scientific Computing and Data Analysis}, Department of Computer Science, Durham University, \small Durham, United Kingdom.\\
	\textsc{2021} & Specialization: Earth and Environmental Sciences\\
	& Dissertation: \emph{``GPU Programming with Standard C++''}\\ 
	& \small Description: Used NVIDIA HPC SDK compiler suite to accelerate ExaHyPE's Finite Volume scheme, a\\
...
%------------------------------------------------	
	...
	&\small Description: Development of a finite difference scheme for evolving the relativistic Vlasov equation in\\
	&\hspace{1.7cm} \small the context of a black hole metric. This approach assumes the equation is advective, with\\
	&\hspace{1.7cm} \small velocities that vary with both time and position.\\
...
\begin{tabular}{r|p{11cm}}
	...
	\textsc{Present}& ML Research and Development Programmer at \textsc{Rockstar Games}\\
	\textsc{Mar 2023}& \small Edinburgh, Scotland.\\
	\multicolumn{2}{c}{} \\
	
	%------------------------------------------------

	\textsc{Mar 2023}& Associate ML Research and Development Programmer at \textsc{Rockstar Games}\\
	\textsc{Sep 2022}& \small London, England.\\
	\multicolumn{2}{c}{} \\
...
\section{Scholarships, awards, honours and accomplishments}
\bigskip
\begin{tabular}{r|l}
...
\begin{tabular}{rl}
	...
	\textsc{Occupation:} & Senior DevOps Engineer at Revolut\\
